          ...
          <div class="row">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">Locatia noastra</h6>
                </div>
                   ...
                   <script>
                    var mymap = L.map('mapid').setView([47.1739611, 27.5721062], 18);
                    
                   L.tileLayer('https://api.tiles.mapbox.com/v4/{id}/{z}/{x}/{y}.png?access_token={accessToken}', {
    attribution: 'Map data &copy; <a href="https://www.openstreetmap.org/">OpenStreetMap</a> contributors, <a href="https://creativecommons.org/licenses/by-sa/2.0/">CC-BY-SA</a>, Imagery © <a href="https://www.mapbox.com/">Mapbox</a>',
    maxZoom: 25,
    id: 'mapbox.streets',
    accessToken: 'pk.eyJ1IjoiY3JpbmEtb3RpbGlhIiwiYSI6ImNqd3Z1bWtrNDA5b240M3IxOGU3NmowemgifQ.k-_PDqfHPUjlUNJ27wvgug'
}).addTo(mymap);
var marker = L.marker([47.1739611, 27.5721062]).addTo(mymap);marker.bindPopup("<b>Patiserie Mi ka</b>").openPopup();
