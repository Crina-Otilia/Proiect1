              ...
              <div class="card border-left-primary shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <div class="h5 mb-0 font-weight-bold text-gray-800">Nume:</div>
                            <div class="h5 mb-0 font-italic text-gray-500"><?php echo $row['nume'];?></div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800">Pret:</div>
                          <div class="h5 mb-0 font-italic text-gray-500"><?php echo $row['pret'];?></div>
                    </div>
                    <div class="col-auto">
