...
<form name="search_form" method="post" action="search.php"class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
            <div class="input-group">
              <input type="text" name="search" value="" class="form-control bg-light border-0 small" placeholder="Search for..." aria-label="Search" aria-describedby="basic-addon2">
...
<svg width="500" height="100">
    ...
    <?php endif ?>
        ...
        <div class="container-fluid">
          ...
          <a href="upload.php">Incarca un alt produs</a>
